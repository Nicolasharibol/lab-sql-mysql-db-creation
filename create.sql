...
-- -----------------------------------------------------
-- Table `lab_schema`.`customers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lab_schema`.`customers` (
...
-- -----------------------------------------------------
-- Table `lab_schema`.`saleserson`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lab_schema`.`saleserson` (
...
-- -----------------------------------------------------
-- Table `lab_schema`.`invoices`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lab_schema`.`invoices` (
  `invoice_id` INT NOT NULL,
  `date` DATE NULL,
  `customers_customer_id` INT NOT NULL,
  `saleserson_staff_id` INT NOT NULL,
  PRIMARY KEY (`invoice_id`),
  INDEX `fk_invoices_customers1_idx` (`customers_customer_id` ASC) VISIBLE,
  INDEX `fk_invoices_saleserson1_idx` (`saleserson_staff_id` ASC) VISIBLE,
  CONSTRAINT `fk_invoices_customers1`
    FOREIGN KEY (`customers_customer_id`)
    REFERENCES `lab_schema`.`customers` (`customer_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_invoices_saleserson1`
    FOREIGN KEY (`saleserson_staff_id`)
    REFERENCES `lab_schema`.`saleserson` (`staff_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `lab_schema`.`cars`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lab_schema`.`cars` (
  `VIN` INT NOT NULL,
  ...
  CONSTRAINT `fk_cars_invoices`
    ...
    REFERENCES `lab_schema`.`invoices` (`invoice_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `lab_schema`.`customers_has_saleserson`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lab_schema`.`customers_has_saleserson` (
  `customers_customer_id` INT NOT NULL,
  `saleserson_staff_id` INT NOT NULL,
  PRIMARY KEY (`customers_customer_id`, `saleserson_staff_id`),
  INDEX `fk_customers_has_saleserson_saleserson1_idx` (`saleserson_staff_id` ASC) VISIBLE,
  INDEX `fk_customers_has_saleserson_customers1_idx` (`customers_customer_id` ASC) VISIBLE,
  CONSTRAINT `fk_customers_has_saleserson_customers1`
    FOREIGN KEY (`customers_customer_id`)
    REFERENCES `lab_schema`.`customers` (`customer_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_customers_has_saleserson_saleserson1`
    FOREIGN KEY (`saleserson_staff_id`)
    REFERENCES `lab_schema`.`saleserson` (`staff_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
